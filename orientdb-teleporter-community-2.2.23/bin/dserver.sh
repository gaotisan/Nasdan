...
exec "$JAVA" $JAVA_OPTS \
    ...
    -Dorientdb.build.number="2.2.x@r1318ca25b3927d22d6a7d5316000e20cb3d9329c; 2017-07-10 14:37:45+0000" \
    -cp "$ORIENTDB_HOME/lib/orientdb-server-2.2.23.jar:$ORIENTDB_HOME/lib/*:$ORIENTDB_HOME/plugins/*" \
